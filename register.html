          ...
          <div class="container-fluid content-wrap">
              <div class="row">
                  <div class="col-md-5 left left-for-register">
                      <a href="index.html"><div class="logo logo-white"></div><span class="white">Track</span></a>
                  ...
                  <div class="col-md">
                      <div class="login-option">
                          <label for="login">Already have an account?</label> <a href="login.html"><button id="login">Login</button></a>
                      </div>
