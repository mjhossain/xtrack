    ...
    <div class="body-wrap">
        <div class="side-nav">
            ...
            <nav>
                ...
                <a href="account_manage.php" title="Account"><button class="nav-item"><img src="images/dashboard-img/user.png" width="40%"></button></a>
                ...
                <div class="col-lg-12">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $q = "SELECT * FROM transctions WHERE user_id = $user_id ORDER BY id DESC";
